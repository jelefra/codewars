...
const even_or_odd = require("./katas/018-8-even-or-odd");
...
const digital_root = require("./katas/033-6-sum-of-digits-digital-root");
...
const array_diff = require("./katas/064-6-array-dot-diff");
...
describe("Test all kata solutions", () => {
  ...
  it("033", () => {
    ...
    expect(digital_root(456)).toEqual(6);
  });
  ...
  it("040", () => {
    ...
    expect(countSheep(array1)).toEqual(17);
  });
  ...
  it("045", () => {
    ...
    expect(findNeedle(haystack_1)).toEqual("found the needle at position 3");
    expect(findNeedle(haystack_2)).toEqual("found the needle at position 5");
    expect(findNeedle(haystack_3)).toEqual("found the needle at position 30");
  });
